...
async def gradientDescentTrain(gradientDescentService: GradientDescentServiceImpl =
    ...
    return JSONResponse(content={"result": result}, stauts_code=status.HTTP_200_OK)
...
async def gradientDescentPredict(requestForm: PredictRequestForm,
        ...
        predictions = await gradientDescentService.gradientDescentPredict(requestForm.toPredcitRequest())
